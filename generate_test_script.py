...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate a Test Suite for MP-FSM evaluation given json file")
    ...
    parser.add_argument("-I", "--image", default="mp-fsm-eval", help="Name of the image")
    parser.add_argument("-N", "--network", default="mp-fsm-eval-internal-lan", help="Name of the network")
    parser.add_argument("-C", "--cformat", default="mp-fsm-eval", help="Prefix for Container names")
