...
echo 'REPETITIONS=3'
docker exec mp-fsm-eval-0 ./compile.py -M fsm_eval_debug 16 16 4 6 3 2 >$null
docker exec mp-fsm-eval-0 bash -c 'echo 4 0 1 1 2 > gf2n_vals.in && ./gen_input_f2n.x && mv gf2n_vals.out Player-Data/Private-Input-0' >$null 2>&1
docker exec mp-fsm-eval-1 ./compile.py -M fsm_eval_debug 16 16 4 6 3 2 >$null
docker exec mp-fsm-eval-1 bash -c 'echo 6 5 5 1 1 1 1 > gf2n_vals.in && ./gen_input_f2n.x && mv gf2n_vals.out Player-Data/Private-Input-1' >$null 2>&1
docker exec mp-fsm-eval-2 ./compile.py -M fsm_eval_debug 16 16 4 6 3 2 >$null
docker exec mp-fsm-eval-2 bash -c 'echo 3 a f 4 > gf2n_vals.in && ./gen_input_f2n.x && mv gf2n_vals.out Player-Data/Private-Input-2' >$null 2>&1
docker exec mp-fsm-eval-3 ./compile.py -M fsm_eval_debug 16 16 4 6 3 2 >$null
docker exec mp-fsm-eval-3 bash -c 'echo 2 0 0 > gf2n_vals.in && ./gen_input_f2n.x && mv gf2n_vals.out Player-Data/Private-Input-3' >$null 2>&1
echo 'SUM_OF_DATA=47'
echo 'Repetition 1'
